...
function extractClinicalSymptoms(text, language = 'en') {
  ...
  for (const term of norm.detectedMedicalTerms) {
    ...
    if (term.canonical === 'நெஞ்சு வலி' || term.canonical === 'सीने में दर्द' || term.canonical === 'chest pain') {
      ...
      name = 'Dizziness';
    } else if (term.canonical === 'கண் வலி' || term.canonical === 'ஆँखों में दर्द' || term.canonical === 'eye pain') {
      name = 'Eye pain';
  ...
  // Direct English/Tanglish/Tamil fallback patterns for breathing, knee pain, vomiting, weakness, eye, dental
